    ...
    if predict_mode == 'single':
        for meter_name in meter_name_list:
            ...
            for appliance_id in appliance_id_list:
                ...
                # if appliance_name not in ["虎牌电热水壶"]:
                    continue
                try:
                ...
                raw_test_directory = 'data_process/' + dataset + '/processed_dataset/1min_csv/' + predict_mode + '/' + meter_name + '_' + appliance_name + '_test_raw_.csv'
                ...
                appliance_count = 1
                tester = Tester(meter_name, appliance_name, batch_size, model_type, predict_mode, meter_name_list, test_directory, raw_test_directory, saved_model_dir,
