        ...
        for appliance_id in appliance_id_list:
            ...
            for i in range(2):
                ...
                if i == 0:
                    ...
                    postfix = ""
                    df_align = single_normalization(df_align, meter_name, appliance_name, 'database')
                ...
                test.to_csv(save_path + meter_name + '_' + appliance_name + '_test_' + postfix + '.csv', index=False, header=False)
                ...
                val.to_csv(save_path + meter_name + '_' + appliance_name + '_validation_' + postfix + '.csv', index=False, header=False)

                # Training CSV
                df_align.to_csv(save_path + meter_name + '_' + appliance_name + '_training_' + postfix + '.csv', index=False, header=False)
