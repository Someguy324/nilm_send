    ...
    if predict_mode == 'single':
        for meter_name in meter_name_list:
            ...
            for appliance_id in appliance_id_list:
                ...
                if appliance_name not in ["移动空气净化器(D-Breath800)", "苏泊尔电磁炉", "虎牌电热水壶", "澳柯玛冰柜"]:
                    continue
                try:
                ...
                scv_name = meter_name + '_' + appliance_name
                ...
                training_directory_raw = 'data_process/' + dataset + '/processed_dataset/1min_csv/' + predict_mode + "/" + meter_name + '_' + appliance_name + '_training_raw_.csv'
                ...
                validation_directory_raw = 'data_process/' + dataset + '/processed_dataset/1min_csv/' + predict_mode + "/" + meter_name + '_' + appliance_name + '_validation_raw_.csv'
                ...
                trainer = Trainer(scv_name, appliance_name, appliance_threshold, batch_size, model_type,
        ...
        training_directory_raw = 'data_process/' + dataset + '/processed_dataset/1min_csv/' + predict_mode + "/" + 'all' + '_training_raw_.csv'
        validation_directory = 'data_process/' + dataset + '/processed_dataset/1min_csv/' + predict_mode + "/" + 'all' + '_validation_.csv'
        validation_directory_raw = 'data_process/' + dataset + '/processed_dataset/1min_csv/' + predict_mode + "/" + 'all' + '_validation_raw_.csv'
        save_model_dir = "saved_models/" + model_type + "_1min/" + predict_mode + "/" + 'all' + "_" + model_type + "_model.h5"
        appliance_count = get_appliance_count()
        appliance_threshold = cf.getint('threshold', 'common')
        trainer = Trainer(scv_name, 'all', appliance_threshold,  batch_size, model_type,
                          training_directory, training_directory_raw, validation_directory, validation_directory_raw,
                          save_model_dir, predict_mode, appliance_count,
